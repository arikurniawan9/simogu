  ...
  return (
    <div className="min-h-screen transition-colors duration-500 p-4 sm:p-6 relative">
      ...
      <div className="max-w-6xl mx-auto space-y-6 relative z-10">
        ...
        <header className="flex items-center justify-between p-4 glass-card rounded-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900 dark:text-slate-50 tracking-tight">
                Master Data Kelas (SMP / SMA / SMK)
              </h1>
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Kelola rombel kelas per jenjang pendidikan SMP, SMA, dan SMK
              </p>
            </div>
          </div>
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="px-3 py-2 rounded-md text-xs font-bold bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white shadow-md shadow-emerald-600/20 transition-all flex items-center gap-1.5"
            >
              <Download className="w-3.5 h-3.5" /> Ekspor Excel
            </button>
            <button
              onClick={() => setImportModalOpen(true)}
              className="px-3 py-2 rounded-md text-xs font-bold bg-amber-600 hover:bg-amber-700 active:scale-95 text-white shadow-md shadow-amber-600/20 transition-all flex items-center gap-1.5"
            >
              <Upload className="w-3.5 h-3.5" /> Impor Excel
            </button>
            <button
              onClick={handleOpenCreate}
              className="px-3.5 py-2 rounded-md text-xs font-bold bg-brand-600 hover:bg-brand-700 active:scale-95 text-white shadow-md shadow-brand-600/25 transition-all duration-200 flex items-center gap-1.5"
            >
        ...
        <div className="glass-card p-3 rounded-lg flex items-center gap-3 overflow-x-auto border-l-4 border-l-brand-600">
          <div className="flex items-center gap-1.5 text-xs font-extrabold text-slate-800 dark:text-slate-200 ml-2 mr-1">
      ...
      {formOpen && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg max-w-md w-full p-6 shadow-2xl space-y-4">
            <h3 className="text-lg font-bold text-slate-900 dark:text-slate-50 border-b border-slate-100 dark:border-slate-800 pb-3">
