          ...
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 truncate">
                Jadwal Jam Pelajaran (SMP / SMA / SMK)
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                ...
                <span className="text-[10px] text-brand-600 dark:text-brand-400 font-mono">Tahap 1</span>
              </label>
              <CustomSelect
                options={[
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                ...
                <span className="text-[10px] text-brand-600 dark:text-brand-400 font-mono">Tahap 2</span>
              </label>
              <CustomSelect
          ...
          <div className="glass-card p-6 sm:p-12 rounded-2xl text-center space-y-3 border border-dashed border-slate-300 dark:border-slate-800 shadow-lg">
            ...
            <div className="space-y-1 max-w-md mx-auto">
              <h3 className="text-base font-extrabold text-slate-900 dark:text-slate-100 tracking-tight">
                Pilih Filter Jenjang & Hari Terlebih Dahulu
              </h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                Pilih jenjang sekolah dan hari pelajaran pada pilihan di atas, atau klik tombol <span className="font-bold text-brand-600">&apos;Semua Jadwal Hari Ini&apos;</span>.
              </p>
            </div>
          </div>
        ) : (
              ...
              <div>
                <div className="text-xs sm:text-sm font-extrabold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                  ...
                  <span className="text-brand-600 font-black">
                    {showToday ? 'Semua Hari Ini' : `${selectedJenjang} - ${selectedDay}`}
                  </span>
                </div>
