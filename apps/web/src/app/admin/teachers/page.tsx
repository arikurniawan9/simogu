          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-extrabold text-slate-900 dark:text-slate-50 tracking-tight">
                Master Data Guru (Multi-Jenjang & Multi-Mapel)
              </h1>
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Guru dapat mengajar di lebih dari 1 jenjang (SMP/SMA/SMK) & lebih dari 1 mata pelajaran
              </p>
            </div>
          </div>
        ...
        <div className="glass-card p-4 sm:p-6 rounded-lg space-y-4 border-l-4 border-l-brand-600 shadow-xl shadow-brand-500/5 transition-all relative z-30 overflow-visible">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-slate-800/80 pb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs sm:text-sm font-extrabold text-slate-900 dark:text-slate-100 tracking-tight">
                Filter Interaktif Master Data Guru
              </span>
            </div>
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
              <span>Pilih Jenjang Sekolah Mengajar Guru</span>
              <span className="text-[10px] text-brand-600 dark:text-brand-400 font-mono">Pilih Opsi Jenjang</span>
            </label>
          ...
          <div className="glass-card p-8 sm:p-12 rounded-lg text-center space-y-4 border border-dashed border-slate-300 dark:border-slate-800 shadow-lg">
            ...
            <div className="space-y-1 max-w-md mx-auto">
              <h3 className="text-base sm:text-lg font-extrabold text-slate-900 dark:text-slate-100 tracking-tight">
                Silakan Pilih Jenjang Mengajar Terlebih Dahulu
              </h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                Pilih <span className="font-bold text-slate-700 dark:text-slate-300">Jenjang Sekolah</span> pada Opsi Select di atas untuk memuat daftar pengajar, atau klik tombol <span className="font-bold text-brand-600">&apos;Tampilkan Semua Data Guru&apos;</span>. Guru dapat mengajar di 2 jenjang atau lebih & lebih dari 1 mata pelajaran.
              </p>
            </div>
          </div>
        ) : (
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4 gap-3">
              <div>
                <div className="text-xs sm:text-sm font-extrabold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                  ...
                  <span>Menampilkan Guru Mengajar:</span>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg max-w-md w-full p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-800 pb-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500">Lengkapi profil, multi-jenjang & multi-mata pelajaran</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSave} className="space-y-3">
              <div>
                <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
                  Jenjang Mengajar Guru (Bisa Dipilih &gt; 1) <span className="text-rose-500">*</span>
                </label>
                  ...
                  {(['SMP', 'SMA', 'SMK'] as EducationLevel[]).map((lvl) => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-2 px-3 rounded-md text-xs font-bold transition-all border flex items-center justify-center gap-1.5 ${
                          isChecked
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
                  Mata Pelajaran (Pisahkan Koma jika mengajar &gt; 1 mapel) <span className="text-rose-500">*</span>
                </label>
                <input
                  type="text"
                  ...
                  className="w-full px-3 py-2 rounded-md bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 text-xs text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-1 focus:ring-brand-500 font-medium"
                />
                <p className="text-[10px] text-slate-400 mt-1">
                  💡 Masukkan beberapa mata pelajaran dipisahkan tanda koma (e.g. <span className="italic font-mono">Fisika, Matematika</span>).
                </p>
              </div>
